...
public class ShoptoysPage {
  ...
  private static final String VALENTINE_BEAR_PRICE = "14.99";

  private static final String FLUFFY_BUNNY_PRICE = "9.99";

  private static final String STUFFED_FROG_PRICE = "10.99";
  ...
  public void validate_price() {
	  try {
		  ...
		  Assert.assertTrue("price of product1 is incorrect", (product1_price).equals(STUFFED_FROG_PRICE));
		  Assert.assertTrue("price of product2 is incorrect", (product2_price).equals(FLUFFY_BUNNY_PRICE));
		  Assert.assertTrue("price of product3 is incorrect", (product3_price).equals(VALENTINE_BEAR_PRICE));
  }
	  catch (Error e) {
	       verificationErrors.append(e.toString());
	     }
